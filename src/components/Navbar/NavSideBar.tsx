                ...
                <div className='my-15'>
                    ...
                    }
                    {
                        env === 'development' ?
                            <>
                                <hr />
                                <Text subtitle className='mt-3 !text-[18px]'>Tutorials</Text>
                                <LinkTo href='/pages/tutorial/javascript.tsx' passHref className='text-[16px] block my-3'>
                                    Javascript
                                </LinkTo>
                                <LinkTo href='/pages/tutorial/style-guide.tsx' passHref className='text-[16px] block my-3'>
                                    Tailwind CSS Style Guide
                                </LinkTo>
                                <LinkTo href='/pages/tutorial/nextjs.tsx' passHref className='text-[16px] block my-3'>
                                    NextJS
                                </LinkTo>
                                <LinkTo href='/pages/tutorial/angular.tsx' passHref className='text-[16px] block my-3'>
                                    Angular
                                </LinkTo>
                                <LinkTo href='/pages/tutorial/api.tsx' passHref className='text-[16px] block my-3'>
                                  RESTFUL API
                                </LinkTo>
                                <LinkTo href='/pages/tutorial/github.tsx' passHref className='text-[16px] block my-3'>
                                    Github tips
                                </LinkTo>
                                <LinkTo href='/pages/tutorial/webdev.tsx' passHref className='text-[16px] block my-3'>
                                    Web developer tips
                                </LinkTo>
