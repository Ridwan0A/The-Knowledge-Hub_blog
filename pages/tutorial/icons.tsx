...
const Icons = () => {
    const PAGE_SEO: iSEO = {
        title: 'Icons',
        keywords: 'knowledge, contact us, ridwan0abdullahi@gmail.com, next js blog',
        author: 'Ridwan'
    }
    return (
        <PageLayout PAGE_SEO={PAGE_SEO} home>
            <div className="container pb-5 md:mt-[50px] pt-20 md:pt-0">
                ...
                <Image src="/public/imp_assets/tutorials/reacticons.png" alt="" caption="ReactIcons website screenshot" />
