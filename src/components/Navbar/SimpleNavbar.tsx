...
import { BsFillShareFill, BsFillMoonFill, BsFillSunFill } from 'react-icons/bs';
  ...
  return (
    <div className={combineClasses(classes.navbar__container, 'container flex items-center justify-between', 'px-2')}>
      ...
      <div className='flex items-center'>
        <div className='text-[14px] font-normal items-center lg:flex hidden'>
          ...
          {socials && (
            <div className='ml-5 pt-1'>
              {socials.map((each: iNavSocials, i: number) => (
                <a
                  href={each.link}
                  key={i}
                  target='_blank'
        ...
        <div
          className={combineClasses(classes.search_icon_wrapper, 'ml-5 dark:text-white')}
          onClick={() => openSearch()}
        >
        ...
        <button
          ...
          className={combineClasses(classes.theme_switch, 'pl-3 dark:text-white text-black')}
          onClick={changeTheme}
        >
