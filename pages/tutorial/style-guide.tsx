    ...
    return (
        <PageLayout>
            <section className="container md:pt-10 pt-20">
                ...
                <br/>
                <br />
                Tailwind CSS is a utility-first CSS framework that provides a highly efficient way to build user interfaces. Unlike traditional CSS frameworks that come with pre-designed components and predefined styles, Tailwind CSS focuses on providing a set of utility classes that you can apply directly to your HTML elements to achieve the desired styling.
                </div>
                ...
                <Seperator />
                <div className="px-4 py-3 dark:bg-slate-800 bg-blue-200 rounded my-5">
                    These are some the basics you need to know about changing the styling with tailwind css, go to the official docs for more info and if you have any issues or queries please feel free to write at <u>ridwan0abdullahi@gmail.com</u>
                </div>
            </section>
        </PageLayout>
    )
