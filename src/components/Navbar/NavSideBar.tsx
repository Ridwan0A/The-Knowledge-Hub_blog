...
const NavSidebar = ({
  ...
  return (
    <>
      {openSidebar ? <div className="backdrop" onClick={closeNavSidebar}></div> : null}
        ...
        <div className="my-15">
          ...
          {env === "development" ? (
            <>
              ...
              <LinkTo
                href="/pages/tutorial/javascript.tsx"
                passHref
                className="text-[16px] block my-3"
              >
                Javascript
              ...
              <LinkTo
                href="/pages/tutorial/nextjs.tsx"
                passHref
                className="text-[16px] block my-3"
              >
                NextJS
              ...
              <LinkTo
                href="/pages/tutorial/angular.tsx"
                passHref
                className="text-[16px] block my-3"
              >
                Angular
              ...
              <LinkTo
                href="/pages/tutorial/github.tsx"
                passHref
                className="text-[16px] block my-3"
              >
                Github tips
              ...
              <LinkTo
                href="/pages/tutorial/webdev.tsx"
                passHref
                className="text-[16px] block my-3"
              >
                Web developer tips
